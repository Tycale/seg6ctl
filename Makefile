all:
	cd libnlmem && gcc -c nlmem.c -g -Wall -pthread -W -I/usr/include/libnl3 && cd ..
	cd libseg6 && gcc -c seg6.c -g -Wall -pthread -W -I/usr/include/libnl3 -I../libnlmem && cd ..
	gcc -o seg6ctl seg6ctl.c libnlmem/nlmem.o libseg6/seg6.o -g -Wall -pthread -W -Ilibnlmem -Ilibseg6 -I/usr/include/libnl3 -lnl-3 -lnl-genl-3
